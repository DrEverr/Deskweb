...
class DiceEightWidget extends DiceNWidget {
  final int n;

  const DiceEightWidget(
      {super.key,
      required this.n,
      required super.size,
...
class DiceEightPainter extends DicePainter {
  final int n;
  const DiceEightPainter(
