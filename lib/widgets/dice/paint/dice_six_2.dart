...
class DiceSix2Widget extends DiceNWidget {
  const DiceSix2Widget(
      {super.key,
      required super.size,
  ...
  Widget build(BuildContext context) {
    return Center(
      child: CustomPaint(
        size: Size(size, size),
        painter:
            DiceSix2Painter(bgColor: backgroundColor, fgColor: foregroundColor),
      ),
    );
  }
}

class DiceSix2Painter extends DicePainter {
  const DiceSix2Painter({required Color bgColor, required Color fgColor})
